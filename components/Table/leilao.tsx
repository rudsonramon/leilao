                ...
                registros.map(item => {
                  return (
                    <Tr>
                      ...
                      <Td>
                        {!item[fieldId[3]] ? ('Imagem não encontrada') : (
                            <Image borderRadius='full' boxSize="60px" src={item[fieldId[3]]} />
                        )}
                      </Td>
                      <Td>{item[fieldId[4]]}</Td>
                      <Td>
                        {!item[fieldId[5]] ? ('Imagem não encontrada') : (
                            <Image borderRadius='full' boxSize="60px" src={item[fieldId[5]]} />
                        )}
                      </Td>
                      <Td>{item[fieldId[6]]}</Td>
                      <Td>
                        <Button size='md' colorScheme='blue' onClick={() => { handleUpdate({"id":item['id']}) }}>Atualizar</Button>
                      </Td>
                    </Tr>
                  )
                })
